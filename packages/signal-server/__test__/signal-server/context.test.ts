...
describe('initContext', () => {
  it('init context to state', () => {
    ...
    const runner = new ServerRunner(mockBM.plainObjectState)
  ...
  it('access model getter without context', () => {
    ...
    const runner = new ServerRunner(mockBM.oneModel)
  ...
  it('callHook remote', async () => {
    ...
    const clientRunner = new ServerRunner(mockBM.changeStateInputComputeServer)
    ...
    it('call remote compute with deps', async () => {
      mockBM.initModelConfig({
        async postComputeToServer (c: IHookContext) {
          ...
          const serverRunner = new ServerRunner(mockBM.changeStateInputComputeServer2)
      ...
      const clientRunner = new ServerRunner(mockBM.changeStateInputComputeServer2)
  ...
  describe('context serialization to server', () => {
    ...
    it('simple', () => {
      const clientRunner = new ServerRunner(mockBM.changeOver3ChainDriver)
