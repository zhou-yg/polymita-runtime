import {
  ServerRunner, debuggerLog, IDiff, IHookContext, IQueryWhere,
...
describe('model', () => {
  ...
  describe('mount model', () => {
    ...
    it('find immediate', async () => {
      const runner = new ServerRunner(mockBM.userPessimisticModel)
    ...
    it('find with injectModel', async () => {
      const runner = new ServerRunner(mockBM.userInjectFindModel)
      const result = runner.init()
    ...
    it('check exist before create', async () => {
      const runner = new ServerRunner(mockBM.userModelInputeCompute)
      const result = runner.init()
    ...
    it('query where computed', async () => {
      const runner = new ServerRunner(mockBM.userModelComputedQuery)
      const result = runner.init()
      await runner.ready()
      expect(result.users()).toEqual([])
    ...
    it('model used in computed (with chain) ', async () => {
      const runner = new ServerRunner(mockBM.modelInComputed)
  ...
  describe('dependent models', () => {
    it('apply compute patches sequence', async () => {
      const runner = new ServerRunner(mockBM.multiPatchesInputCompute)
      const result = runner.init()
  ...
  describe('dynamic model indexes', () => {
    it('compose sub package driver', async () => {
      const runner = new ServerRunner(mockBM.composeDriverWithNamespace, {
        beleiveContext: true,
        modelIndexes: {
          item: 'item',
          'sub/package': {
  ...
  describe('write model', () => {
    it('inject write model', async () => {  
      const runner = new ServerRunner(mockBM.writeWritePrisma)
      const result = runner.init()
    ...
    it('connectModel', async () => {
      const runner = new ServerRunner(mockBM.writeModelWithSource)
      const result = runner.init()
    ...
    it('write model by quick command',async () => {
      const runner = new ServerRunner(mockBM.writeModelByQuickCommand)
      const result = runner.init()
